...
class TestCBCGrade10HistoryTopic4(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 4 must exist in History Grade 10."
    ...
    def test_01_topic_hierarchy_metadata(self):
        ...
        self.assertIn("Political Developments in Kenya Since Independence", self.topic.name)
    ...
    def test_02_learning_units(self):
        ...
        expected_units = [
            (1, "Post-Independence Political Chronology"),
            (2, "Political Challenges and Possible Solutions"),
            (3, "Promoting Peaceful Political Environments"),
            (4, "Political History Inquiry")
        ]
    ...
    def test_04_pages_and_cards_structure(self):
        ...
        self.assertEqual(total_pages, 28, "Total pages across topic 4 must be 28.")
    ...
    def test_09_source_analysis_and_tables(self):
        ...
        self.assertGreaterEqual(table_blocks.count(), 4, "Expected at least 4 comparison tables across topic.")

        step_blocks = LessonBlock.objects.filter(lesson__topic=self.topic, block_type="step_process")
        self.assertGreaterEqual(step_blocks.count(), 4, "Expected at least 4 step process / inquiry blocks.")
