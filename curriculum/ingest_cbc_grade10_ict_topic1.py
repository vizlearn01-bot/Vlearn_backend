...
from curriculum.cbc_grade10_ict_topic1_data import TOPIC_1_LESSONS
...
def clean_text(text: str) -> str:
    ...
    text = re.sub(r'\[(?:VISUAL:[^\]]*|MISCONCEPTION|PRACTICAL TASK)\]', '', text)
...
def ingest_grade10_ict_topic1(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 1: Introduction to ICT (Grade 10 CBC)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Foundational concepts of ICT, infrastructure components, digital interaction and communication channels, and the transformative impact of ICT in society."
        }
    )
    if not t_created:
        topic.name = "Introduction to ICT"
        topic.description = "Foundational concepts of ICT, infrastructure components, digital interaction and communication channels, and the transformative impact of ICT in society."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_ict_t1_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_ict_topic1(replace=True)
