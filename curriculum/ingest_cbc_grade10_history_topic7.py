...
Curriculum: CBC
Topic Order: 7
Topic Name: "Topic 2.1: Human Developments in Africa"
"""
...
from curriculum.cbc_grade10_history_topic7_data import TOPIC_7_LESSONS
...
def ingest_grade10_history_topic7(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 7: Human Developments in Africa (Grade 10 CBC History)")
    print("=" * 80)
    ...
    topic_name = "Topic 2.1: Human Developments in Africa"
    topic_description = (
        "Multidimensional human development concepts, the Neolithic Revolution in Africa, "
        "pastoralism as an adaptive ecological pathway, and contemporary challenges and solutions for African pastoralists."
    )
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t7_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_history_topic7(replace=True)
