...
def validate_form3_topic5():
    print("================================================================================")
    print("RUNNING COMPREHENSIVE VALIDATION: Form 3 Chemistry Topic 5 (Sulphur & Compounds)")
    print("================================================================================")
    ...
    # 2. Verify Topic 5
    topic = Topic.objects.filter(subject=subject, name__startswith="Topic 5: Sulphur").first()
    assert topic is not None, "Topic 5 (Sulphur and its Compounds) does not exist!"
    print(f"✅ Topic validated: {topic.name} (ID: {topic.id})")

    # 3. Verify Learning Units
    expected_modules = [
        "Module 5.1: Extraction of Sulphur (Frasch Process) and Allotropes",
        "Module 5.2: Physical and Chemical Properties of Sulphur",
        "Module 5.3: Sulphur(IV) Oxide: Preparation, Properties, and Reactions",
        "Module 5.4: Sulphuric(VI) Acid and the Contact Process",
        "Module 5.5: Hydrogen Sulphide and Sulphur-Based Environmental Pollution"
    ]

    units = list(LearningUnit.objects.filter(topic=topic).order_by("order"))
    assert len(units) == 5, f"Expected exactly 5 modules in Topic 5, found {len(units)}"
    ...
    print("\n================================================================================")
    print("ALL VALIDATION CHECKS PASSED: Form 3 Chemistry Topic 5 is 100% Student-Ready!")
    print("================================================================================")

if __name__ == "__main__":
    validate_form3_topic5()
