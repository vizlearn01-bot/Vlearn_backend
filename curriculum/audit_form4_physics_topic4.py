...
Audits the database for:
  ...
  - Topic 4 and its 3 Learning Units
...
def audit_topic4():
    print("=" * 80)
    print("AUDIT: FORM 4 PHYSICS — TOPIC 4: ELECTROMAGNETIC SPECTRUM")
    print("=" * 80)
    ...
    if not topic:
        print("ERROR: Topic 4 not found in database!")
        return
    ...
    print("\n" + "=" * 80)
    print(f"TOPIC 4 AUDIT SUMMARY: {units.count()} Units | {total_blocks} Total Blocks | {total_assets} Visual Assets")
    print("=" * 80)
