...
Verifies:
  1. Hierarchy & Database Integrity (Curriculum CBC -> Grade 10 -> CRE -> Topic 1.7)
...
class TestCBCGrade10CRETopic1_7(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 1.7 (Order: 7) not found under Grade 10 CRE!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertIn("Loyalty to God (Elijah)", self.topic.name)
