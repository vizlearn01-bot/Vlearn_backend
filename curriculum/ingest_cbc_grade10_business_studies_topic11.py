...
from curriculum.cbc_grade10_business_studies_topic11_data import TOPIC_11_LESSONS
...
def ingest_grade10_business_studies_topic11(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 11: Public Finance (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            "name": "Public Finance",
            "description": "Comprehensive macroeconomic study of public finance, government expenditure, revenue mobilization, Adam Smith's canons of taxation, direct and indirect taxes, customs duties and protectionism, tax compliance ethics, and budget deficit calculations."
        }
    )
    if not t_created:
        topic.name = "Public Finance"
        topic.description = "Comprehensive macroeconomic study of public finance, government expenditure, revenue mobilization, Adam Smith's canons of taxation, direct and indirect taxes, customs duties and protectionism, tax compliance ethics, and budget deficit calculations."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t11_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_business_studies_topic11(replace=True)
