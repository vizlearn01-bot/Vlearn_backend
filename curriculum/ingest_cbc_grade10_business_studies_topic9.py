...
from curriculum.cbc_grade10_business_studies_topic9_data import TOPIC_9_LESSONS
...
def ingest_grade10_business_studies_topic9(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 9: Production (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            "name": "Production",
            "description": "Meaning and importance of production, factors of production, costs in a production unit, cost decisions, division of labour, specialisation, producer responsibilities to consumers, and product labelling."
        }
    )
    if not t_created:
        topic.name = "Production"
        topic.description = "Meaning and importance of production, factors of production, costs in a production unit, cost decisions, division of labour, specialisation, producer responsibilities to consumers, and product labelling."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t9_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_business_studies_topic9(replace=True)
