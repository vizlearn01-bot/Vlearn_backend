...
class TestCBCGrade10BusinessStudiesTopic1(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 1 'Money' not found under Business Studies!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Money")
    ...
    def test_06_youtube_video_assets(self):
        ...
        self.assertGreaterEqual(coverage, 80.0, f"Topic 1 video coverage below 80%: {coverage}%")

    def test_07_content_sanitization(self):
        """Verify zero bracket citations ([568], [1]), zero developer prompt leakage, and clean math."""
        for lesson in self.lessons:
    ...
    def test_08_formative_mcqs(self):
        ...
        self.assertGreaterEqual(mcq_count, 12, f"Expected >= 12 MCQs in Topic 1, found {mcq_count}")
