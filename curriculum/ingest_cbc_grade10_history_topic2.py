...
Curriculum: CBC
Topic Order: 2
Topic Name: "Topic 1.2: Establishment of Colonial Rule"
"""
...
from curriculum.cbc_grade10_history_topic2_data import TOPIC_2_LESSONS
...
def ingest_grade10_history_topic2(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 2: Establishment of Colonial Rule (Grade 10 CBC History)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        order=2,
        defaults={
            "name": "Topic 1.2: Establishment of Colonial Rule",
            "description": "Motives, methods of conquest, colonial consolidation, African agency, collaboration, resistance, and long-term legacies of British rule in Kenya."
        }
    )
    if not t_created:
        topic.name = "Topic 1.2: Establishment of Colonial Rule"
        topic.description = "Motives, methods of conquest, colonial consolidation, African agency, collaboration, resistance, and long-term legacies of British rule in Kenya."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t2_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_history_topic2(replace=True)
