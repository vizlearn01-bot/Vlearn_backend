...
Verifies:
  1. Hierarchy resolution (CBC -> Grade 7 -> Home Science -> Topic 1: Kitchen Safety)
  ...
  6. Zero bracket citations ([232], [234]) and zero developer meta-language leaks
...
class TestCBCGrade7HomeScienceTopic1(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic = Topic.objects.filter(subject=cls.subject, name="Kitchen Safety").first()
    ...
    def test_01_hierarchy_resolution(self):
        """Test that Topic 1 resolves under CBC -> Grade 7 -> Home Science."""
        ...
        self.assertIsNotNone(self.topic, "Topic 'Kitchen Safety' not found")
        self.assertEqual(self.topic.order, 1, "Topic order must be 1")
        print("\n[QA PASS] Hierarchy correctly resolved to Grade 7 Topic 1: Kitchen Safety (ID: 108).")
    ...
    def test_06_zero_bracket_citations_and_meta_language(self):
        ...
        print("[QA PASS] Zero bracket citations and zero developer meta-language leaks detected across all 35 blocks.")
