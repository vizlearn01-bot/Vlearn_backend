"""
VLearn Form 4 History — Automated Test Suite for Topic 9: The Electoral Process and Functions of Government in Other Parts of the World

Verifies:
  1. Target Subject, Grade, Curriculum mapping (History, Form 4, 844)
  2. Topic 9 existence and ordering (Order: 9)
  3. Exact 5 Learning Units and 5 Lessons
  4. Exact 81 Pages across the 5 Lessons (16, 15, 16, 16, 18)
...
Usage:
  ./venv/bin/python curriculum/test_form4_history_topic9.py
"""
...
def test_form4_history_topic9():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 HISTORY TOPIC 9 (ELECTORAL PROCESS & WORLD GOVERNANCE)")
    print("=" * 80)
    ...
    # 2. Check Topic
    topic = Topic.objects.filter(subject=subject, name="The Electoral Process and Functions of Government in Other Parts of the World").first()
    assert topic, "Topic 9 not found!"
    assert topic.order == 9, f"Topic order is {topic.order}, expected 9"
    ...
    print("[PASS] 4.1 Every single lesson in Topic 9 has an establishing real-world visual on Page 1.")
    ...
    expected_pages = {
        1: 16, # The Kenyan Electoral Process: Voting Evolution, IEBC Structure & Functions, Candidate Rules, and Field Administration
        2: 15, # The 2007 Electoral Crisis: ECK Failures, Kriegler Commission Findings, and 2010 Constitutional Reforms
        3: 16, # The British Government: Unwritten Constitution, Electoral Process, Parliament, and Parliamentary Supremacy
        4: 16, # The United States Government: Federalism, Presidential Elections, Congress, and Checks & Balances
        5: 18  # The Indian Government: Federal Parliamentary System, Sansad, Global Comparative Matrix, and Course Synthesis
    }
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 History Topic 9 is fully verified, robust, and production-ready!")
