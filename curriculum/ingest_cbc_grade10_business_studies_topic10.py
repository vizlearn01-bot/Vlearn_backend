...
from curriculum.cbc_grade10_business_studies_topic10_data import TOPIC_10_LESSONS
...
def ingest_grade10_business_studies_topic10(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 10: Consumer Satisfaction (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Comprehensive study of consumer satisfaction, terms and conditions of supply, causes of consumer dissatisfaction, legal and commercial remedies, customer satisfaction survey design, data analysis, and service improvement driving long-term enterprise sustainability."
        }
    )
    if not t_created:
        topic.name = "Consumer Satisfaction"
        topic.description = "Comprehensive study of consumer satisfaction, terms and conditions of supply, causes of consumer dissatisfaction, legal and commercial remedies, customer satisfaction survey design, data analysis, and service improvement driving long-term enterprise sustainability."
        topic.save()
    print(f"[*] Resolved Topic 10: {topic.name} (ID: {topic.id})")

    if replace:
        print("[*] Replacing existing Topic 10 units, lessons, blocks, and assets...")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t10_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_business_studies_topic10(replace=True)
