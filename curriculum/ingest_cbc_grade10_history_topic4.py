...
Grade: Grade 10
Curriculum: CBC
Topic 4: Topic 1.4: Political Developments in Kenya Since Independence
"""
...
from curriculum.cbc_grade10_history_topic4_data import TOPIC_4_LESSONS
...
def ingest_grade10_history_topic4(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 4: Political Developments in Kenya Since Independence (Grade 10 History)")
    print("=" * 80)
    ...
    topic_name = "Topic 1.4: Political Developments in Kenya Since Independence"
    topic_desc = "Constitutional transitions, the one-party era, return to multi-party democracy, post-independence political challenges and systemic solutions, peacebuilding strategies, and applied historical inquiry."
    ...
    if not topic:
        ...
        topic.save()
        print(f"[*] Resolved & Updated Topic 4: {topic.name} (ID: {topic.id})")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t4_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print("TOPIC 4 INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_history_topic4(replace=True)
