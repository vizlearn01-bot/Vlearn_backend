"""
VLearn Form 4 Geography — Automated Test Suite for Topic 9: Settlement

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Geography (ID: 18)
  2. Topic 9 existence and ordering (Topic Order: 9, Name: Settlement)
  3. Exact 6 Learning Units and 6 published Lessons
  4. 65 Total Pages across all 6 Lessons
...
Usage:
  ./venv/bin/python curriculum/test_form4_geography_topic9.py
"""
...
def test_form4_geography_topic9():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 GEOGRAPHY TOPIC 9 (SETTLEMENT)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Settlement' not found!"
    ...
    expected_pages = {
        1: 11, # Foundations, Site, Situation
        2: 11, # Rural Patterns & Functions
        3: 11, # Urbanization & Urban Hierarchy
        4: 12, # Spatial Structure & Zones
        5: 12, # Urban Challenges & Solutions
        6: 8   # Nairobi vs New York & Review
    }
    ...
    assert total_pages == 65, f"Total pages is {total_pages}, expected 65"
    print(f"[PASS] 5. Total Pages across all 6 Lessons: {total_pages} (Matches target: 65)")
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Geography Topic 9 (Settlement) is fully verified and production-ready!")
