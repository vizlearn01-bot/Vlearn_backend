...
Production Ingestion Script for Lessons 8, 9, and 10
"""
...
from curriculum.cbc_grade10_english_topic1_data import TOPIC_1_LESSONS_8_TO_10
...
def ingest_grade10_english_topic1_lessons_8_9_10(replace=True):
    print("=" * 80)
    print("INGESTING CBC GRADE 10 ENGLISH — TOPIC 1: LISTENING & SPEAKING (LESSONS 8, 9, 10)")
    print("=" * 80)
    ...
    # 3. Resolve or Create Topic 1 'Listening and Speaking' (Order 1)
    topic, t_created = Topic.objects.get_or_create(
        subject=subject,
        order=1,
        defaults={
            "name": "Listening and Speaking",
            "description": "Mastering oral communication, pronunciation, stress, fluency, presentation, debate, and collaborative decision-making."
        }
    )
    if not t_created:
        topic.name = "Listening and Speaking"
        topic.description = "Mastering oral communication, pronunciation, stress, fluency, presentation, debate, and collaborative decision-making."
        topic.save()
    ...
    with transaction.atomic():
        for item in TOPIC_1_LESSONS_8_TO_10:
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_eng_t1_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print(f"  Units Ingested:   {units_created} (Units 8, 9, 10)")
...
if __name__ == "__main__":
    ingest_grade10_english_topic1_lessons_8_9_10(replace=True)
