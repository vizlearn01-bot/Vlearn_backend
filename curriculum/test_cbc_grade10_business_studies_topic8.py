...
class TestCBCGrade10BusinessStudiesTopic8(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 8 'Entrepreneurship' not found under Business Studies!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Entrepreneurship")
