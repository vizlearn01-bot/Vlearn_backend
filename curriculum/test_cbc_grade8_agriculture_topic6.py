...
Tests:
  ...
  6. test_06_multi_video_integration: Verifies YouTube video lessons across Units 2, 4, 8, and 9.
...
Usage:
  ./venv/bin/python curriculum/test_cbc_grade8_agriculture_topic6.py
"""
...
class TestCBCGrade8AgricultureTopic6(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic = Topic.objects.filter(subject=cls.subject, name="Preparation of Animal Products").first()
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertIsNotNone(self.topic, "Topic 'Preparation of Animal Products' must exist")
    ...
    def test_07_zero_citation_and_meta_leaks(self):
        """Audit all blocks for citation brackets [1], [421], developer meta-terms, and raw unrendered LaTeX."""
