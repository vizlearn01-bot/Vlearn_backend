...
Tests:
  1. Hierarchy & Database Integrity (Curriculum -> Grade 10 -> Agriculture -> Topic 8: Breeds of Livestock)
...
Usage:
  ./venv/bin/python curriculum/test_cbc_grade10_agriculture_topic8.py
"""
...
class TestCBCGrade10AgricultureTopic8(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic = Topic.objects.filter(subject=cls.subject, name="Breeds of Livestock").first()
        assert cls.topic, "Topic 8 'Breeds of Livestock' not found under Agriculture!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Breeds of Livestock")
    ...
    def test_05_custom_vector_svgs(self):
        ...
        expected_svg_units = [1, 2, 3, 4, 6, 7, 9, 10]
