...
Grade: Grade 10
Curriculum: CBC
Topic 3: Topic 1.3: The Constitution of Kenya (2010) — Public Resources
"""
...
from curriculum.cbc_grade10_history_topic3_data import TOPIC_3_LESSONS
...
def ingest_grade10_history_topic3(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 3: The Constitution of Kenya (2010) — Public Resources (Grade 10 History)")
    print("=" * 80)
    ...
    topic_name = "Topic 1.3: The Constitution of Kenya (2010) — Public Resources"
    topic_desc = "Stewardship, classification, utilization challenges, sustainable management, and constitutional inquiry into Kenya's public wealth under the Constitution of Kenya (2010)."
    ...
    if not topic:
        ...
        topic.save()
        print(f"[*] Resolved & Updated Topic 3: {topic.name} (ID: {topic.id})")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t3_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_history_topic3(replace=True)
