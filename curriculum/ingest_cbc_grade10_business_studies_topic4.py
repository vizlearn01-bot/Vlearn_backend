...
from curriculum.cbc_grade10_business_studies_topic4_data import TOPIC_4_LESSONS
...
def ingest_grade10_business_studies_topic4(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 4: Banking (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            "name": "Banking",
            "description": "The role of banking in economic development, types of bank accounts, ethical practices, modern banking trends in Kenya, and opening junior savings accounts."
        }
    )
    if not t_created:
        topic.name = "Banking"
        topic.description = "The role of banking in economic development, types of bank accounts, ethical practices, modern banking trends in Kenya, and opening junior savings accounts."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t4_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
