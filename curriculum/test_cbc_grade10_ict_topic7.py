...
class TestCBCGrade10ICTTopic7(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 7 'Introduction to the Internet' not found under ICT!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Introduction to the Internet")
        self.assertTrue(self.topic.description, "Topic 7 missing description")
    ...
    def test_06_youtube_video_assets(self):
        ...
        print(f"[*] Topic 7 Video Coverage: {video_count}/{len(self.lessons)} ({coverage:.1f}%)")
    ...
    def test_08_formative_mcqs(self):
        ...
        self.assertGreaterEqual(mcq_count, 10, f"Expected >= 10 MCQs across Topic 7, found {mcq_count}")
