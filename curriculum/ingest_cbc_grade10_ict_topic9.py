"""
VLearn CBC Grade 10 ICT — Topic 9: Digital Citizenship
...
- Subject: ICT
- Topic: Digital Citizenship (Order: 9)

Decomposed into 6 Learning Units & 6 Published 5-Page Lessons:
  1. Lesson 9.1.1: What is Digital Citizenship and Why It Matters
  2. Lesson 9.1.2: Netiquette: Appropriate Online Behaviors
  3. Lesson 9.1.3: Evaluating Online Information and Ethical Research
  4. Lesson 9.1.4: Managing Your Digital Identity and Privacy
  5. Lesson 9.1.5: Ergonomics and Healthy ICT Practices
  6. Lesson 9.1.6: Environmental Conservation in ICT
"""
...
from curriculum.cbc_grade10_ict_topic9_data import TOPIC_9_LESSONS
...
def ingest_grade10_ict_topic9(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 9: Digital Citizenship (Grade 10 ICT)")
    print("=" * 80)
    ...
    topic_description = (
        "Principles of digital citizenship, six societal pillars, netiquette and online communication standards, "
        "evaluating online information and ethical research (CRAAP test), managing digital identity and privacy defense, "
        "computer workstation ergonomics and health practices, and environmental conservation in ICT (e-waste & green computing)."
    )
    ...
    if not t_created:
        topic.name = "Digital Citizenship"
        topic.description = topic_description
        topic.save()
    print(f"[*] Resolved Topic 9: {topic.name} (ID: {topic.id})")

    # 2. Clear Existing Data for Topic 9 if Replace is True
    if replace:
        print("[*] Replacing existing Topic 9 units, lessons, blocks, and assets...")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_ict_t9_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print(f"TOPIC 9 (DIGITAL CITIZENSHIP) INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_ict_topic9(replace=True)
