"""
VLearn Form 4 Biology — Automated Test Suite for Topic 2: Evolution

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Biology (ID: 13)
  2. Topic 2 existence and ordering (Topic Order: 2, Name: Evolution)
  3. Exact 8 Learning Units and 8 published Lessons
  4. 71 Total Pages across all 8 Lessons
...
Usage:
  ./venv/bin/python curriculum/test_form4_biology_topic2.py
"""
...
def test_form4_biology_topic2():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 BIOLOGY TOPIC 2 (EVOLUTION)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Evolution' not found!"
    ...
    expected_pages = {
        1: 10, # Intro to Evolution & Origin of Life
        2: 7,  # Chemical Evolution Pathway
        3: 10, # Fossils, Hominids & Biogeography
        4: 11, # Homology, Analogy, Cytology & Serology
        5: 10, # Lamarck vs Darwin
        6: 10, # Industrial Melanism, Resistance & Speciation
        7: 7,  # Practical Lab & Field Studies
        8: 6   # Topic Synthesis & Review
    }
    ...
    assert total_pages == 71, f"Total pages is {total_pages}, expected 71"
    print(f"[PASS] 5. Total Pages across all 8 Lessons: {total_pages} (Matches target: 71)")
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Biology Topic 2 (Evolution) is fully verified and production-ready!")
