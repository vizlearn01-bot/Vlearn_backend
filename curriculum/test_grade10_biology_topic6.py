...
Validates:
  1. Curriculum Hierarchy (CBC -> Grade 10 -> Biology -> Topic 6)
  2. Learning Units & Published Lessons 1-to-1 Parity (5 Comprehensive Lessons)
  3. Concept Card Distribution & Page Numbering (45 Total Cards)
  ...
  7. Content Leak Audit (Zero [VISUAL: ...] tags, zero citation brackets [220], zero corrupted LaTeX)

Usage:
  ./venv/bin/python curriculum/test_grade10_biology_topic6.py
"""
...
def run_tests():
    print("=" * 80)
    print("RUNNING AUTOMATED QA: GRADE 10 BIOLOGY TOPIC 6 (PLANT TRANSPORT)")
    print("=" * 80)
    ...
    if not topic:
        errors.append("Topic 'Plant Transport' not found under Grade 10 Biology!")
    ...
    leak_patterns = [
        ...
        (r'\[(?:\d+|image_\d+)\]', "Raw Bracket Citation Leak [e.g. 220]"),
    ...
    print("\n[SUCCESS] ALL GRADE 10 BIOLOGY TOPIC 6 TESTS PASSED!")
    return True
