...
def finalize_all_lessons():
    print("Finalizing all lessons across Form 3 Chemistry with clean component separation...")

    # Load Topics
    t22 = Topic.objects.get(id=22) # Gas Laws
    t23 = Topic.objects.get(id=23) # The Mole
    t24 = Topic.objects.get(id=24) # Organic Chemistry I

    # Definition of clean cards for all 21 lessons
    lessons_data = {
        # =====================================================================
        # LESSON 169: STOICHIOMETRY & MOLAR GAS VOLUMES
        # =====================================================================
        169: {
            "topic": t23,
    ...
    for lid, data in lessons_data.items():
        ...
        print(f"Lesson {lid} successfully updated with clean component separation.")

if __name__ == "__main__":
    finalize_all_lessons()
