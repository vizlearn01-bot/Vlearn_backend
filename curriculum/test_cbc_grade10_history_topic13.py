...
from curriculum.ingest_cbc_grade10_history_topic13 import ingest_grade10_history_topic13


class TestCBCGrade10HistoryTopic13(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 13 must exist in History Grade 10."
    ...
    def test_01_topic_hierarchy_metadata(self):
        ...
        self.assertIn("International Organisations", self.topic.name)
    ...
    def test_02_learning_units(self):
        ...
        expected_units = [
            (1, "Why International Organisations Exist"),
            (2, "The Commonwealth Focus"),
            (3, "Cooperation and Citizenship")
        ]
