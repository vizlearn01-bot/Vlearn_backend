...
from curriculum.ingest_cbc_grade10_history_topic15 import ingest_grade10_history_topic15


class TestCBCGrade10HistoryTopic15(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 15 must exist in History Grade 10."
    ...
    def test_01_topic_hierarchy_metadata(self):
        ...
        self.assertIn("Peacebuilding in Kenya", self.topic.name)
    ...
    def test_02_learning_units(self):
        ...
        expected_units = [
            (1, "National Peace Activities"),
            (2, "The Constitution (2010) and Conflict Prevention"),
            (3, "Applied Case and Peace Simulation")
        ]
