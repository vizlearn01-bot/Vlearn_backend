...
from curriculum.cbc_grade10_business_studies_topic5_data import TOPIC_5_LESSONS
...
def ingest_grade10_business_studies_topic5(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 5: Business Activities (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Exploration of human needs and wants, factors of production, scarcity, choice, opportunity cost, classification of business activities, and micro/macro business environment."
        }
    )
    if not t_created:
        topic.name = "Business Activities"
        topic.description = "Exploration of human needs and wants, factors of production, scarcity, choice, opportunity cost, classification of business activities, and micro/macro business environment."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t5_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
