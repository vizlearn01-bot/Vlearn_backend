"""
VLearn Form 4 History — Automated Test Suite for Topic 4: National Philosophies (Kenya)

Verifies:
  1. Target Subject, Grade, Curriculum mapping (History, Form 4, 844)
  2. Topic 4 existence and ordering (Order: 4)
  ...
  7. Zero bracket citations ([74], [225], [1]) across all blocks
  8. Zero internal developer/generation metadata leaks
  9. 100% LessonAsset associations (Images + Videos)

Usage:
  ./venv/bin/python curriculum/test_form4_history_topic4.py
"""
...
def test_form4_history_topic4():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 HISTORY TOPIC 4 (NATIONAL PHILOSOPHIES)")
    print("=" * 80)
    ...
    # 2. Check Topic
    topic = Topic.objects.filter(subject=subject, name="National Philosophies (Kenya)").first()
    assert topic, "Topic 'National Philosophies (Kenya)' not found!"
    ...
    print("[PASS] 4.1 Every single lesson in Topic 4 has an establishing real-world visual on Page 1.")
    ...
    expected_pages = {
        1: 15, # African Socialism: Origins, Principles, and Features
        2: 15, # The Harambee Philosophy: Origins, Principles, and Categories
        3: 15, # Harambee in National Development: Contributions and Challenges
        4: 16, # The Nyayo Philosophy: Origins, Pillars, and Development Programs
        5: 18  # Cumulative Impacts and Synthesis of Kenya's National Philosophies
    }
    ...
    # 9. Check for Bracket Citation Leakage ([74], [225], [1])
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 History Topic 4 is fully verified, robust, and production-ready!")
