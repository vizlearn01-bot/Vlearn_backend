"""
Form 4 Agriculture — Topic 5 Ingestion Engine
...
Usage:
    ./venv/bin/python curriculum/ingest_form4_agriculture_topic5.py [--replace]
"""
...
from curriculum.topic5_agriculture_data import TOPIC_5_LESSONS

CURRICULUM_ID = 4
GRADE_ID = 4
SUBJECT_ID = 19
TOPIC_ID = 99
TOPIC_NAME = "Agricultural Economics IV (Farm Accounts)"
TOPIC_ORDER = 5


def ingest_topic5(replace=False):
    print("=" * 80)
    print("STARTING FORM 4 AGRICULTURE TOPIC 5 INGESTION ENGINE")
    print("=" * 80)
    ...
    with transaction.atomic():
        for lesson_data in TOPIC_5_LESSONS:
    ...
    print("\n" + "=" * 80)
    print("FORM 4 AGRICULTURE TOPIC 5 INGESTION COMPLETE")
    print(f"Total Lessons: {len(TOPIC_5_LESSONS)}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest Form 4 Agriculture Topic 5")
    parser.add_argument("--replace", action="store_true", help="Replace existing units/lessons for Topic 5")
