...
from curriculum.cbc_grade10_business_studies_topic7_data import TOPIC_7_LESSONS
...
def ingest_grade10_business_studies_topic7(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 7: Social Responsibility of Business (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Justifying social responsibility, community CSR activities, operational challenges, designing school-based social projects, project implementation, and monitoring, evaluation, and reporting."
        }
    )
    if not t_created:
        topic.name = "Social Responsibility of Business"
        topic.description = "Justifying social responsibility, community CSR activities, operational challenges, designing school-based social projects, project implementation, and monitoring, evaluation, and reporting."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t7_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
