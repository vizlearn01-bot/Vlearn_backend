...
Production Ingestion Script for Lessons 1 to 8
"""
...
from curriculum.cbc_grade9_english_topic1_data import TOPIC_1_LESSONS
...
def ingest_grade9_english_topic1(replace=True):
    print("=" * 80)
    print("INGESTING CBC GRADE 9 ENGLISH — TOPIC 1: LISTENING AND SPEAKING (LESSONS 1 TO 8)")
    print("=" * 80)
    ...
    topic_description = (
        "Mastering oral communication, polite language and euphemisms, expressing feelings and "
        "empathetic listening, negotiation and win-win trade-offs, job interview skills and the STAR method, "
        "impromptu speeches (PREP framework) and oral reports, selective listening and note-taking, "
        "phonetics (diphthongs and semi-vowels), and sentence stress with question tag intonation."
    )
    ...
    print(f"  Units Ingested:   {units_created} (Units 1 to 8)")
...
if __name__ == "__main__":
    ingest_grade9_english_topic1(replace=True)
