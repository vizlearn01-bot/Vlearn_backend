...
from curriculum.ingest_cbc_grade10_history_topic11 import ingest_grade10_history_topic11


class TestCBCGrade10HistoryTopic11(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 11 must exist in History Grade 10."
    ...
    def test_01_topic_hierarchy_metadata(self):
        ...
        self.assertIn("Global Governance", self.topic.name)
    ...
    def test_02_learning_units(self):
        ...
        expected_units = [
            (1, "Meaning and Principles of Global Governance"),
            (2, "Areas and Importance of Global Governance"),
            (3, "Emerging Issues and the UN Role"),
            (4, "Promoting Responsible Global Citizenship")
        ]
    ...
    def test_04_pages_and_cards_structure(self):
        ...
        self.assertGreaterEqual(total_pages, 20)
