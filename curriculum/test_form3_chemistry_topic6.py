"""
Test suite for Form 3 Chemistry Topic 6: Chlorine and its Compounds
"""
...
def test_form3_chemistry_topic6():
    ...
    # Verify videos in Lesson 191 and 193
    l191 = Lesson.objects.get(id=191)
    l193 = Lesson.objects.get(id=193)
    assert LessonAsset.objects.filter(lesson=l191, asset_type='youtube').exists(), "Lesson 191 missing video"
    assert LessonAsset.objects.filter(lesson=l193, asset_type='youtube').exists(), "Lesson 193 missing video"

    print("✅ All 4 Form 3 Chemistry Topic 6 lessons passed validation tests!")

if __name__ == "__main__":
    test_form3_chemistry_topic6()
