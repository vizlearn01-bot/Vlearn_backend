"""
VLearn Form 4 Biology — Automated Test Suite for Topic 3: Reception, Response and Coordination

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Biology (ID: 13)
  2. Topic 3 existence and ordering (Topic Order: 3, Name: Reception, Response and Coordination in Plants and Animals)
  3. Exact 10 Learning Units and 10 published Lessons
  4. 73 Total Pages across all 10 Lessons
...
Usage:
  ./venv/bin/python curriculum/test_form4_biology_topic3.py
"""
...
def test_form4_biology_topic3():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 BIOLOGY TOPIC 3 (RESPONSE & COORDINATION)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Reception, Response and Coordination in Plants and Animals' not found!"
    ...
    expected_pages = {
        1: 5,  # Intro to Response Systems
        2: 7,  # Sensory Pathways & Networks
        3: 9,  # Tropisms, Taxes & Nasty
        4: 7,  # Auxin Physiology & Plant Labs
        5: 9,  # Neurone Anatomy & Synapses
        6: 8,  # Brain, Spinal Cord & Reflex Arcs
        7: 7,  # Endocrine Glands & Drug Abuse
        8: 8,  # Eye Anatomy & Accommodation
        9: 7,  # Ear Anatomy & Balance
        10: 6  # Topic Synthesis & Review
    }
    ...
    assert total_pages == 73, f"Total pages is {total_pages}, expected 73"
    print(f"[PASS] 5. Total Pages across all 10 Lessons: {total_pages} (Matches target: 73)")
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Biology Topic 3 (Response & Coordination) is fully verified and production-ready!")
