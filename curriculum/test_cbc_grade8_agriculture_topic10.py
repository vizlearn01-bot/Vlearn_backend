...
Usage:
  ./venv/bin/python curriculum/test_cbc_grade8_agriculture_topic10.py
"""
...
class TestCBCGrade8AgricultureTopic10(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic = Topic.objects.filter(subject=cls.subject, name="Sewing and Production Techniques").first()
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertIsNotNone(self.topic, "Topic 'Sewing and Production Techniques' must exist")
        self.assertEqual(self.topic.order, 10, "Topic order must be 10")
