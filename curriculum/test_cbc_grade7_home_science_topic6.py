...
Verifies:
  1. Hierarchy resolution (CBC -> Grade 7 -> Home Science -> Topic 6: The Sewing Machine)
  ...
  6. Zero bracket citations ([95], [97], [98]) and zero developer meta-language leaks
...
class TestCBCGrade7HomeScienceTopic6(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic = Topic.objects.filter(subject=cls.subject, name="The Sewing Machine").first()
    ...
    def test_01_hierarchy_resolution(self):
        """Test that Topic 6 resolves under CBC -> Grade 7 -> Home Science."""
        ...
        self.assertIsNotNone(self.topic, "Topic 'The Sewing Machine' not found")
        self.assertEqual(self.topic.order, 6, "Topic order must be 6")
        print("\n[QA PASS] Hierarchy correctly resolved to Grade 7 Topic 6: The Sewing Machine (ID: 113).")
