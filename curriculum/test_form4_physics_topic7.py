"""
Automated Pytest Test Suite for Form 4 Physics — Topic 7: Cathode Rays

Validates:
  1. Curriculum hierarchy linkage (844 -> Form 4 -> Physics -> Topic 7)
...
class TestPhysicsTopic7Ingestion:
    ...
    def test_curriculum_hierarchy_exists(self):
        ...
        assert self.topic is not None, "Topic 'Topic 7: Cathode Rays' not found"
