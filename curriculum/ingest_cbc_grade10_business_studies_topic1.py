...
from curriculum.cbc_grade10_business_studies_topic1_data import TOPIC_1_LESSONS
...
def ingest_grade10_business_studies_topic1(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 1: Money (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            "name": "Money",
            "description": "Features, functions, demand, supply, and ethical practices involving money in the Kenyan economy."
        }
    )
    if not t_created:
        topic.name = "Money"
        topic.description = "Features, functions, demand, supply, and ethical practices involving money in the Kenyan economy."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t1_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
