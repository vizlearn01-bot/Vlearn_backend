...
def validate_form3_topic4():
    print("================================================================================")
    print("RUNNING COMPREHENSIVE VALIDATION: Form 3 Chemistry Topic 4 (Nitrogen & Compounds)")
    print("================================================================================")
    ...
    # 2. Verify Topic 4
    topic = Topic.objects.filter(subject=subject, name__startswith="Topic 4: Nitrogen").first()
    assert topic is not None, "Topic 4 (Nitrogen and its Compounds) does not exist!"
    print(f"✅ Topic validated: {topic.name} (ID: {topic.id})")

    # 3. Verify Learning Units
    expected_modules = [
        "Module 4.1: Isolation and Laboratory Preparation of Nitrogen Gas",
        "Module 4.2: Oxides of Nitrogen (Dinitrogen oxide, Nitrogen monoxide, Nitrogen dioxide)",
        "Module 4.3: Ammonia and the Haber Process",
        "Module 4.4: Nitrogenous Fertilisers",
        "Module 4.5: Nitric(V) Acid (Laboratory Preparation and Industrial Manufacture)",
        "Module 4.6: Chemical Reactions of Nitric(V) Acid and Nitrates"
    ]

    units = list(LearningUnit.objects.filter(topic=topic).order_by("order"))
    assert len(units) == 6, f"Expected exactly 6 modules in Topic 4, found {len(units)}"
    ...
    print("\n================================================================================")
    print("ALL VALIDATION CHECKS PASSED: Form 3 Chemistry Topic 4 is 100% Student-Ready!")
    print("================================================================================")

if __name__ == "__main__":
    validate_form3_topic4()
