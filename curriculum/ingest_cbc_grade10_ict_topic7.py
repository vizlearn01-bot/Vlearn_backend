...
- Subject: ICT
- Topic: Introduction to the Internet (Order: 7)

Decomposed into 5 Learning Units & 5 Published 5-Page Lessons:
  1. Lesson 7.1.1: Meaning, History, and Purpose of the Internet
  2. Lesson 7.1.2: Common Services Offered Through the Internet
  3. Lesson 7.1.3: Fundamental Components of an Internet Connection
  4. Lesson 7.1.4: Establishing and Managing an Internet Connection
  5. Lesson 7.1.5: Using Search Engines and Basic Web Navigation
"""
...
from curriculum.cbc_grade10_ict_topic7_data import TOPIC_7_LESSONS
...
def ingest_grade10_ict_topic7(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 7: Introduction to the Internet (Grade 10 ICT)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Foundations of the Internet and World Wide Web, Intranet vs Extranet architectures, URL deconstruction, online public and commercial services, connectivity hardware, mobile hotspot setup and wireless security, search engine algorithms, Boolean query refinement, and CRAAP web source evaluation."
        }
    )
    if not t_created:
        topic.name = "Introduction to the Internet"
        topic.description = "Foundations of the Internet and World Wide Web, Intranet vs Extranet architectures, URL deconstruction, online public and commercial services, connectivity hardware, mobile hotspot setup and wireless security, search engine algorithms, Boolean query refinement, and CRAAP web source evaluation."
        topic.save()
    print(f"[*] Resolved Topic 7: {topic.name} (ID: {topic.id})")

    # 2. Clear Existing Data for Topic 7 if Replace is True
    if replace:
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_ict_t7_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print(f"TOPIC 7 (INTRODUCTION TO THE INTERNET) INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_ict_topic7(replace=True)
