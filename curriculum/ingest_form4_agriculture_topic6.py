"""
Form 4 Agriculture — Topic 6 Ingestion Engine
...
Usage:
    ./venv/bin/python curriculum/ingest_form4_agriculture_topic6.py [--replace]
"""
...
from curriculum.topic6_agriculture_data import TOPIC_6_LESSONS

CURRICULUM_ID = 4
GRADE_ID = 4
SUBJECT_ID = 19
TOPIC_ID = 100
TOPIC_NAME = "Agricultural Economics V (Agricultural Marketing and Organisations)"
TOPIC_ORDER = 6


def ingest_topic6(replace=False):
    print("=" * 80)
    print("STARTING FORM 4 AGRICULTURE TOPIC 6 INGESTION ENGINE")
    print("=" * 80)
    ...
    with transaction.atomic():
        for lesson_data in TOPIC_6_LESSONS:
    ...
    print("\n" + "=" * 80)
    print("FORM 4 AGRICULTURE TOPIC 6 INGESTION COMPLETE")
    print(f"Total Lessons: {len(TOPIC_6_LESSONS)}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest Form 4 Agriculture Topic 6")
    parser.add_argument("--replace", action="store_true", help="Replace existing units/lessons for Topic 6")
