"""
Form 4 Agriculture — Topic 7 Ingestion Engine
Topic: Agroforestry
Curriculum: 844 (ID: 4) | Grade: Form 4 (ID: 4) | Subject: Agriculture (ID: 19) | Topic ID: 101 (Order: 7)

Usage:
    ./venv/bin/python curriculum/ingest_form4_agriculture_topic7.py [--replace]
"""
...
from curriculum.topic7_agriculture_data import TOPIC_7_LESSONS

CURRICULUM_ID = 4
GRADE_ID = 4
SUBJECT_ID = 19
TOPIC_ID = 101
TOPIC_NAME = "Agroforestry"
TOPIC_ORDER = 7


def ingest_topic7(replace=False):
    print("=" * 80)
    print("STARTING FORM 4 AGRICULTURE TOPIC 7 INGESTION ENGINE")
    print("=" * 80)
    ...
    with transaction.atomic():
        for lesson_data in TOPIC_7_LESSONS:
    ...
    print("\n" + "=" * 80)
    print("FORM 4 AGRICULTURE TOPIC 7 INGESTION COMPLETE")
    print(f"Total Lessons: {len(TOPIC_7_LESSONS)}")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest Form 4 Agriculture Topic 7")
    parser.add_argument("--replace", action="store_true", help="Replace existing units/lessons for Topic 7")
