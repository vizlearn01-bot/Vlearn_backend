...
def validate_form3_topic3():
    print("================================================================================")
    print("RUNNING COMPREHENSIVE VALIDATION: Form 3 Chemistry Topic 3 (Organic Chemistry I)")
    print("================================================================================")
    ...
    # 2. Verify Topic
    topic = Topic.objects.filter(subject=subject, name="Topic 3: Organic Chemistry I (Aliphatic Hydrocarbons)").first()
    assert topic is not None, "Topic 3: Organic Chemistry I not found!"
    print(f"✅ Topic validated: {topic.name} (ID: {topic.id})")

    # 3. Verify Learning Units & Lessons
    expected_modules = [
        ("Module 3.1: Introduction to Organic Chemistry and Homologous Series", "Introduction to Organic Chemistry and Homologous Series", 1),
        ("Module 3.2: Alkanes (Nomenclature, Structure, and Isomerism)", "Alkanes (Nomenclature, Structure, and Isomerism)", 2),
        ("Module 3.3: Laboratory Preparation and Chemical Properties of Alkanes", "Laboratory Preparation and Chemical Properties of Alkanes", 3),
        ("Module 3.4: Alkenes (Nomenclature, Structure, and Isomerism)", "Alkenes (Nomenclature, Structure, and Isomerism)", 4),
        ("Module 3.5: Preparation and Chemical Properties of Alkenes (Addition Reactions)", "Preparation and Chemical Properties of Alkenes (Addition Reactions)", 5),
        ("Module 3.6: Alkynes (Nomenclature, Preparation, and Properties)", "Alkynes (Nomenclature, Preparation, and Properties)", 6),
        ("Module 3.7: Industrial Applications of Hydrocarbons (Cracking and Polymerisation)", "Industrial Applications of Hydrocarbons (Cracking and Polymerisation)", 7),
    ]
    ...
    print("\n================================================================================")
    print("ALL VALIDATION CHECKS PASSED: Form 3 Chemistry Topic 3 is 100% Student-Ready!")
    print("================================================================================")

if __name__ == "__main__":
    validate_form3_topic3()
