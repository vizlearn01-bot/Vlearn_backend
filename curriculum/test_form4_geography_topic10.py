"""
VLearn Form 4 Geography — Automated Test Suite for Topic 10: Environment

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Geography (ID: 18)
  2. Topic 10 existence and ordering (Topic Order: 10, Name: Management and Conservation of the Environment)
...
Usage:
  ./venv/bin/python curriculum/test_form4_geography_topic10.py
"""
...
def test_form4_geography_topic10():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 GEOGRAPHY TOPIC 10 (ENVIRONMENT)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Management and Conservation of the Environment' not found!"
    assert topic.order == 10, f"Topic order is {topic.order}, expected 10"
    ...
    expected_pages = {
        1: 11, # Foundations & Ecosystem Services
        2: 12, # Hazards & Natural Disasters
        3: 12, # Degradation & Pollution
        4: 11, # Management & NEMA EIA
        5: 12, # Community Projects & Haller Park
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Geography Topic 10 (Environment) is fully verified and production-ready!")
