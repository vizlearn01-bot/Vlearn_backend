"""
VLearn Form 4 Geography — Automated Test Suite for Topic 4: Energy

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Geography (ID: 18)
  2. Topic 4 existence and ordering (Topic Order: 4)
  ...
  7. Zero bracket citation leaks ([36], [41], [49]) across all blocks
  8. Zero developer meta-language leaks in titles or text

Usage:
  ./venv/bin/python curriculum/test_form4_geography_topic4.py
"""
...
def test_form4_geography_topic4():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 GEOGRAPHY TOPIC 4 (ENERGY)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Energy' not found!"
    ...
    expected_pages = {
        1: 12, # Classification & Renewables
        2: 12, # Biomass, Animals & Non-Renewables
        3: 14, # HEP Site Selection & Projects
        4: 12, # Geothermal Rift Potential
        5: 14, # Global Oil Crisis & Impacts
        6: 16  # Management, Conservation & KCSE Synthesis
    }
    ...
    # 8. Check for Bracket Citation Leakage ([36], [41], [49])
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Geography Topic 4 (Energy) is fully verified and production-ready!")
