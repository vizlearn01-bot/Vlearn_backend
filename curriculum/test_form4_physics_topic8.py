"""
Automated Pytest Test Suite for Form 4 Physics — Topic 8: X-Rays

Validates:
  1. Curriculum hierarchy linkage (844 -> Form 4 -> Physics -> Topic 8)
...
class TestPhysicsTopic8Ingestion:
    ...
    def test_curriculum_hierarchy_exists(self):
        ...
        assert self.topic is not None, "Topic 'Topic 8: X-Rays' not found"
