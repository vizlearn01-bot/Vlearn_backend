...
def validate_form3_topic2():
    print("================================================================================")
    print("RUNNING COMPREHENSIVE VALIDATION: Form 3 Chemistry Topic 2 (The Mole)")
    print("================================================================================")
    ...
    # 2. Verify Topic
    topic = Topic.objects.filter(subject=subject, name="Topic 2: The Mole: Formulae and Chemical Equations").first()
    assert topic is not None, "Topic 2: The Mole not found!"
    print(f"✅ Topic validated: {topic.name} (ID: {topic.id})")

    # 3. Verify Learning Units & Lessons
    expected_modules = [
        ("Module 2.1: Relative Atomic, Molecular, and Formula Masses", "Relative Atomic, Molecular, and Formula Masses", 1),
        ("Module 2.2: The Mole Concept and Avogadro's Constant", "The Mole Concept and Avogadro's Constant", 2),
        ("Module 2.3: Calculation of Empirical and Molecular Formulae", "Calculation of Empirical and Molecular Formulae", 3),
        ("Module 2.4: Concentration of Solutions and Molar Solutions", "Concentration of Solutions and Molar Solutions", 4),
        ("Module 2.5: Dilution of Solutions", "Dilution of Solutions", 5),
        ("Module 2.6: Stoichiometry of Chemical Equations (Reacting Masses and Volumes)", "Stoichiometry of Chemical Equations (Reacting Masses and Volumes)", 6),
        ("Module 2.7: Volumetric Analysis (Acid-Base Titrations)", "Volumetric Analysis (Acid-Base Titrations)", 7),
        ("Module 2.8: Analyzing Complex Systems: Back Titrations", "Analyzing Complex Systems: Back Titrations", 8),
        ("Module 2.9: Gas Stoichiometry and Redox Titrations", "Gas Stoichiometry and Redox Titrations", 9),
    ]
    ...
    for unit_name, lesson_title, expected_order in expected_modules:
        ...
        # Verify no meta-labels leaked into page titles or block titles
        for b in blocks:
        ...
        print(f"   ✅ Verified {len(blocks)} blocks across {len(pages)} natural concept pages (Zero meta-labels, full KaTeX rigor, interactive MCQs).")

    print("\n================================================================================")
    print("ALL VALIDATION CHECKS PASSED: Form 3 Chemistry Topic 2 is 100% Student-Ready!")
    print("================================================================================")

if __name__ == "__main__":
    validate_form3_topic2()
