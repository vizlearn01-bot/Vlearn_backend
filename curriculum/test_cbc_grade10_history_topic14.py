...
from curriculum.ingest_cbc_grade10_history_topic14 import ingest_grade10_history_topic14


class TestCBCGrade10HistoryTopic14(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 14 must exist in History Grade 10."
    ...
    def test_01_topic_hierarchy_metadata(self):
        ...
        self.assertIn("Modern Slavery", self.topic.name)
    ...
    def test_02_learning_units(self):
        ...
        expected_units = [
            (1, "Defining Modern Slavery and Its Forms"),
            (2, "Causes and Consequences"),
            (3, "Government, Civil Society, and Abolitionist Action"),
            (4, "Evidence and Ethical Citizenship")
        ]
    ...
    def test_04_pages_and_cards_structure(self):
        ...
        self.assertEqual(total_pages, 20)
    ...
    def test_07_knowledge_check_mcqs(self):
        ...
        self.assertGreaterEqual(blocks.count(), 5)
        for b in blocks:
