"""
VLearn Form 4 Geography — Automated Test Suite for Topic 6: Transport and Communication

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Geography (ID: 18)
  2. Topic 6 existence and ordering (Topic Order: 6)
  ...
  7. Zero bracket citation leaks ([63], [67], [74]) across all blocks
  8. Zero developer meta-language leaks in titles or text

Usage:
  ./venv/bin/python curriculum/test_form4_geography_topic6.py
"""
...
def test_form4_geography_topic6():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 GEOGRAPHY TOPIC 6 (TRANSPORT AND COMMUNICATION)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Transport and Communication' not found!"
    ...
    expected_pages = {
        1: 12, # Foundations & Traditional Transport
        2: 12, # Road & Rail Networks in Africa
        3: 13, # Water, Pipeline, Air & Containers
        4: 11, # St. Lawrence Seaway Project
        5: 9,  # Telecommunications & Development
        6: 13  # African Barriers & KCSE Essays
    }
    ...
    # 8. Check for Bracket Citation Leakage ([63], [67], [74])
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Geography Topic 6 (Transport & Communication) is fully verified and production-ready!")
