...
from curriculum.cbc_grade10_business_studies_topic13_data import TOPIC_13_LESSONS
...
def ingest_grade10_business_studies_topic13(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 13: Business Transactions (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Comprehensive study of business transactions, cash transactions, credit transactions, payment channels, and practical enterprise payment policy management in Kenya."
        }
    )
    if not t_created:
        topic.name = "Business Transactions"
        topic.description = "Comprehensive study of business transactions, cash transactions, credit transactions, payment channels, and practical enterprise payment policy management in Kenya."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t13_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
...
if __name__ == "__main__":
    ingest_grade10_business_studies_topic13(replace=True)
