...
Grade: Grade 10
Curriculum: CBC
Topic 5: Topic 1.5: Elections in Kenya
"""
...
from curriculum.cbc_grade10_history_topic5_data import TOPIC_5_LESSONS
...
def ingest_grade10_history_topic5(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 5: Elections in Kenya (Grade 10 History)")
    print("=" * 80)
    ...
    topic_name = "Topic 1.5: Elections in Kenya"
    topic_desc = "The constitutional and statutory framework of Kenyan elections, the structure and functions of the IEBC, democratic accountability, prevention of electoral malpractices, and applied dispute resolution simulation."
    ...
    if not topic:
        ...
        topic.save()
        print(f"[*] Resolved & Updated Topic 5: {topic.name} (ID: {topic.id})")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t5_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print("TOPIC 5 INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_history_topic5(replace=True)
