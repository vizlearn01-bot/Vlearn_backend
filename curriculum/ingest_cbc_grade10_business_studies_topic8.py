...
from curriculum.cbc_grade10_business_studies_topic8_data import TOPIC_8_LESSONS
...
def ingest_grade10_business_studies_topic8(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 8: Entrepreneurship (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Comprehensive study of entrepreneurial competencies, classifications of entrepreneurs, opportunity identification and screening matrix methodologies, business incubation dynamics, and start-up enterprise costing, pricing, and budgeting models."
        }
    )
    if not t_created:
        topic.name = "Entrepreneurship"
        topic.description = "Comprehensive study of entrepreneurial competencies, classifications of entrepreneurs, opportunity identification and screening matrix methodologies, business incubation dynamics, and start-up enterprise costing, pricing, and budgeting models."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t8_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
