...
Curriculum: CBC
Topic Order: 9
Topic Name: "Topic 2.4: Modern Nationalism in Africa"
"""
...
from curriculum.cbc_grade10_history_topic9_data import TOPIC_9_LESSONS
...
def ingest_grade10_history_topic9(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 9: Modern Nationalism in Africa (Grade 10 History)")
    print("=" * 80)
    ...
    topic_name = "Topic 2.4: Modern Nationalism in Africa"
    topic_desc = "Foundations of African nationalism, Pan-Africanism, contrasting models of African agency (Sankara, Tutu, Nyerere, Sadat), national cohesion best practices, regional integration, and evidence-based inquiry."
    ...
    if not topic:
        ...
        topic.save()
        print(f"[*] Resolved & Updated Topic 9: {topic.name} (ID: {topic.id})")
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_hist_t9_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
