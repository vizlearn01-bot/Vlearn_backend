...
class TestCBCGrade10ICTTopic9(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 9 'Digital Citizenship' not found under ICT!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Digital Citizenship")
        self.assertTrue(self.topic.description, "Topic 9 missing description")
    ...
    def test_06_youtube_video_assets(self):
        ...
        print(f"[*] Topic 9 Video Coverage: {video_count}/{len(self.lessons)} ({coverage:.1f}%)")
    ...
    def test_08_formative_mcqs(self):
        ...
        self.assertGreaterEqual(mcq_count, 12, f"Expected >= 12 MCQs across Topic 9, found {mcq_count}")
