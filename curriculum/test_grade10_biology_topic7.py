...
Validates:
  1. Curriculum Hierarchy (CBC -> Grade 10 -> Biology -> Topic 7)
  ...
  7. Content Leak Audit (Zero [VISUAL: ...] tags, zero citation brackets [221], zero corrupted LaTeX)

Usage:
  ./venv/bin/python curriculum/test_grade10_biology_topic7.py
"""
...
def run_tests():
    print("=" * 80)
    print("RUNNING AUTOMATED QA: GRADE 10 BIOLOGY TOPIC 7 (PLANT GASEOUS EXCHANGE & RESPIRATION)")
    print("=" * 80)
    ...
    if not topic:
        errors.append("Topic 'Plant Gaseous Exchange and Respiration' not found under Grade 10 Biology!")
    ...
    leak_patterns = [
        ...
        (r'\[(?:\d+|image_\d+)\]', "Raw Bracket Citation Leak [e.g. 221]"),
    ...
    print("\n[SUCCESS] ALL GRADE 10 BIOLOGY TOPIC 7 TESTS PASSED!")
    return True
