...
from curriculum.cbc_grade10_business_studies_topic15_data import TOPIC_15_LESSONS
...
def ingest_grade10_business_studies_topic15(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 15: Source Documents and Books of Original Entry (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Comprehensive study of source documents, 6-point verification protocols, specialized day books (Sales, Purchases, Returns), single/double/three-column cash books, contra entries, batch posting workflows to general ledgers, and error detection with suspense account reconciliation."
        }
    )
    if not t_created:
        topic.name = "Source Documents and Books of Original Entry"
        topic.description = "Comprehensive study of source documents, 6-point verification protocols, specialized day books (Sales, Purchases, Returns), single/double/three-column cash books, contra entries, batch posting workflows to general ledgers, and error detection with suspense account reconciliation."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t15_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print(f"TOPIC 15 INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_business_studies_topic15(replace=True)
