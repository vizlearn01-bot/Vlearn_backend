...
from curriculum.cbc_grade10_business_studies_topic3_data import TOPIC_3_LESSONS
...
def ingest_grade10_business_studies_topic3(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 3: Budgeting in Business (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Meaning, types, structure, step-by-step preparation, and variance analysis of business and cash budgets for financial control and sustainability."
        }
    )
    if not t_created:
        topic.name = "Budgeting in Business"
        topic.description = "Meaning, types, structure, step-by-step preparation, and variance analysis of business and cash budgets for financial control and sustainability."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t3_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
