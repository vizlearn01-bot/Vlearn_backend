...
Decomposed into 7 Learning Units & 7 Published 5-Page Lessons:
  1. Lesson 8.1.1: Meaning and Importance of Digital Communication
  2. Lesson 8.1.2: Online Platforms for Digital Communication
  3. Lesson 8.1.3: Key Features of Online Platforms
  4. Lesson 8.1.4: Creating Accounts and Safe Profile Configuration
  5. Lesson 8.1.5: Using Email to Send and Receive Messages
  6. Lesson 8.1.6: Ethical Issues in Digital Communication
  7. Lesson 8.1.7: Cloud Collaboration and AI in Digital Communication
"""
...
from curriculum.cbc_grade10_ict_topic8_data import TOPIC_8_LESSONS
...
def ingest_grade10_ict_topic8(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 8: Digital Communication Platforms (Grade 10 ICT)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        order=8,
        defaults={
            "name": "Digital Communication Platforms",
            "description": "Digital communication concepts, synchronous vs asynchronous models, online platform taxonomy, architectural features, account configuration and security, email routing and management, ethical issues and cyber safety, and cloud collaboration with AI tools."
        }
    )
    if not t_created:
        topic.name = "Digital Communication Platforms"
        topic.description = "Digital communication concepts, synchronous vs asynchronous models, online platform taxonomy, architectural features, account configuration and security, email routing and management, ethical issues and cyber safety, and cloud collaboration with AI tools."
        topic.save()
    print(f"[*] Resolved Topic 8: {topic.name} (ID: {topic.id})")

    # 2. Clear Existing Data for Topic 8 if Replace is True
    if replace:
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_ict_t8_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print(f"TOPIC 8 (DIGITAL COMMUNICATION PLATFORMS) INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_ict_topic8(replace=True)
