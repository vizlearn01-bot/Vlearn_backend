...
class TestCBCGrade9EnglishTopic1(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic is not None, "Topic 1 'Listening and Speaking' must exist in Subject 'English'."
    ...
    def test_topic_structure(self):
        ...
        self.assertIn("euphemisms", self.topic.description.lower())
        self.assertIn("negotiation", self.topic.description.lower())

    def test_all_8_units_exist(self):
        ...
        expected_titles = [
            "Polite Language and Euphemisms",
            "Expressing Feelings and Empathetic Listening",
            "Negotiation Skills",
            "Acing the Job Interview",
            "Impromptu Speeches and Oral Reports",
            "Selective Listening and Listening for Details",
            "Phonetics: Diphthongs and Semi-Vowels",
            "Sentence Stress and Intonation (Question Tags)"
        ]
    ...
    def test_lessons_published_and_linked(self):
        ...
        for unit in units:
            ...
            self.assertEqual(lesson.immutable_metadata["topic_order"], 1)
    ...
    def test_mcq_data_integrity(self):
        ...
        self.assertEqual(mcq_blocks.count(), 16, "Expected exactly 16 MCQs across Topic 1.")
    ...
    def test_lesson_assets_attachment(self):
        ...
        self.assertEqual(diagram_assets.count(), 8, "Expected 8 diagram assets.")
        self.assertEqual(image_assets.count(), 8, "Expected 8 image assets.")
        self.assertEqual(video_assets.count(), 8, "Expected 8 video assets.")
