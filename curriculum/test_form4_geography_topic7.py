"""
VLearn Form 4 Geography — Automated Test Suite for Topic 7: Trade

Verifies:
  1. Hierarchy mapping: 844 -> Form 4 -> Geography (ID: 18)
  2. Topic 7 existence and ordering (Topic Order: 7, Name: Trade)
  3. Exact 6 Learning Units and 6 published Lessons
  4. 64 Total Pages across all 6 Lessons
...
Usage:
  ./venv/bin/python curriculum/test_form4_geography_topic7.py
"""
...
def test_form4_geography_topic7():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 GEOGRAPHY TOPIC 7 (TRADE)")
    print("=" * 80)
    ...
    assert topic, "Topic 'Trade' not found!"
    ...
    expected_pages = {
        1: 11, # Intro to Trade & Factors
        2: 12, # Internal Trade Channels
        3: 12, # International Trade & Balance
        4: 12, # Regional Trading Blocs
        5: 11, # Significance & Challenges
        6: 6   # Topic Synthesis & Review
    }
    ...
    assert total_pages == 64, f"Total pages is {total_pages}, expected 64"
    print(f"[PASS] 5. Total Pages across all 6 Lessons: {total_pages} (Matches target: 64)")
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 Geography Topic 7 (Trade) is fully verified and production-ready!")
