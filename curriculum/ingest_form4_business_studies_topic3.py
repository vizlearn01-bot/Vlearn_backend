...
Topic 3: Money and Banking (Order: 3)
...
Architecture:
  ...
  - Lesson 7: Money Transfer Facilities & Non-Bank Financial Institutions (10 Pages)
  - Lesson 8: The Central Bank of Kenya, Monetary Policy & Modern Trends (11 Pages)
  Total: 77 Pages

Features:
  - 100% pedagogical fidelity to Lessons.md and form4_business_studies_extraction.md
  - Automated regex cleaning of all bracket citations ([305], [182], [1])
  - 6-step progressive currency conversion and banking profit calculations
...
Usage:
  ./venv/bin/python curriculum/ingest_form4_business_studies_topic3.py [--replace]
"""
...
from curriculum.topic3_data import (
...
def clean_text(raw_str):
    """Remove source citation brackets like [305], [182], [1] and normalize whitespace."""
...
def run_ingestion(replace=False):
    print("=" * 80)
    print("STARTING FORM 4 BUSINESS STUDIES TOPIC 3 INGESTION ENGINE (MONEY AND BANKING)")
    print("=" * 80)
    ...
    with transaction.atomic():
        ...
        topic, _ = Topic.objects.get_or_create(
            ...
            defaults={
                "order": 3,
                "description": (
                    "Covers barter trade, evolution and characteristics of money, functions, "
                    "demand and supply of money, banking structure, commercial banking, "
                    "non-bank financial institutions, Central Bank monetary policy, and modern trends."
                )
            }
        )
        topic.order = 3
        ...
        print("=" * 80)
        print("[SUCCESS] Form 4 Business Studies Topic 3 Ingestion Complete!")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Ingest Form 4 Business Studies Topic 3")
