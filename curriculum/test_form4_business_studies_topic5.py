"""
VLearn Form 4 Business Studies — Automated Test Suite: Topic 5 (Inflation)
"""
...
def run_tests():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 BUSINESS STUDIES TOPIC 5 (INFLATION)")
    print("=" * 80)
    ...
    assert topic is not None, "Topic 5 (Inflation) not found!"
    assert topic.name == "Inflation", f"Unexpected topic name: {topic.name}"
    ...
    assert assets.count() >= 8, f"Expected at least 8 assets, found {assets.count()}"
    ...
    print("=" * 80)
    print("[ALL TESTS PASSED] Form 4 Business Studies Topic 5 is 100% verified and production-ready!")
    print("=" * 80)
