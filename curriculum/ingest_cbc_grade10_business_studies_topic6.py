...
from curriculum.cbc_grade10_business_studies_topic6_data import TOPIC_6_LESSONS
...
def ingest_grade10_business_studies_topic6(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 6: Types of Business Ownership (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Comprehensive analysis of Sole Proprietorships, Partnerships, and Cooperative Societies, their legal frameworks, formation steps, management structures, finance sources, strategic trade-offs, and role in Kenyan county economic development."
        }
    )
    if not t_created:
        topic.name = "Types of Business Ownership"
        topic.description = "Comprehensive analysis of Sole Proprietorships, Partnerships, and Cooperative Societies, their legal frameworks, formation steps, management structures, finance sources, strategic trade-offs, and role in Kenyan county economic development."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t6_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
