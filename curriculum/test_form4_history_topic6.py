"""
VLearn Form 4 History — Automated Test Suite for Topic 6: Social, Economic and Political Developments and Challenges in Africa Since Independence

Verifies:
  1. Target Subject, Grade, Curriculum mapping (History, Form 4, 844)
  2. Topic 6 existence and ordering (Order: 6)
...
Usage:
  ./venv/bin/python curriculum/test_form4_history_topic6.py
"""
...
def test_form4_history_topic6():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 HISTORY TOPIC 6 (DEVELOPMENTS IN AFRICA)")
    print("=" * 80)
    ...
    # 2. Check Topic
    topic = Topic.objects.filter(subject=subject, name="Social, Economic and Political Developments and Challenges in Africa Since Independence").first()
    assert topic, "Topic 6 not found!"
    assert topic.order == 6, f"Topic order is {topic.order}, expected 6"
    ...
    expected_pages = {
        1: 15, # The Post-Colonial Inheritance: Inherited Crises, Cold War, and Military Coups
        2: 16, # The Democratic Republic of Congo: The Congo Crisis, Mobutu's Dictatorship, and Turmoil
        3: 16, # Tanzania: The 1964 Union, Ujamaa Socialism, National Unity, and Political Stability
        4: 16, # General Political, Economic, and Social Challenges in Post-Colonial Africa
        5: 18  # African Responses, Development Measures, Regional Integration, and Master Synthesis
    }
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 History Topic 6 is fully verified, robust, and production-ready!")
