...
- Subject: ICT
- Topic: Presentation Software (Order: 5)

Decomposed into 5 Learning Units & 5 Published 5-Page Lessons:
  1. Lesson 5.1.1: Meaning and Purpose of Presentation Software
  2. Lesson 5.1.2: Common Presentation Software and Selection
  3. Lesson 5.1.3: Creating Slides and Structuring Content
  4. Lesson 5.1.4: Enhancing Slides with Multimedia and Animation
  5. Lesson 5.1.5: Running and Delivering a Presentation
"""
...
from curriculum.cbc_grade10_ict_topic5_data import TOPIC_5_LESSONS
...
def ingest_grade10_ict_topic5(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 5: Presentation Software (Grade 10 ICT)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            ...
            "description": "Visual oral communication principles, presentation software comparison, slide layouts, Master Slide inheritance, 6x6 rule, multimedia animations, non-linear hyperlinks, and Presenter View delivery."
        }
    )
    if not t_created:
        topic.name = "Presentation Software"
        topic.description = "Visual oral communication principles, presentation software comparison, slide layouts, Master Slide inheritance, 6x6 rule, multimedia animations, non-linear hyperlinks, and Presenter View delivery."
        topic.save()
    print(f"[*] Resolved Topic 5: {topic.name} (ID: {topic.id})")

    # 2. Clear Existing Data for Topic 5 if Replace is True
    if replace:
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_ict_t5_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
    ...
    print("=" * 80)
    print(f"TOPIC 5 (PRESENTATION SOFTWARE) INGESTION COMPLETE:")
...
if __name__ == "__main__":
    ingest_grade10_ict_topic5(replace=True)
