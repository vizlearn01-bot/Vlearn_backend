...
Tests:
  1. Hierarchy & Database Integrity (CBC -> Grade 10 -> Geography -> Topic 2: Map Reading and Interpretation)
  ...
  5. 11 Custom Sanitized Responsive Vector SVGs (viewBox, sanitization & attached LessonAssets)
  6. Verified Educational YouTube Video Asset (Lesson 1)
...
Usage:
  ./venv/bin/python curriculum/test_cbc_grade10_geography_topic2.py
"""
...
class TestCBCGrade10GeographyTopic2(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        assert cls.topic, "Topic 2 'Map Reading and Interpretation' not found under Geography!"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.name, "Map Reading and Interpretation")
    ...
    def test_05_custom_vector_svgs(self):
        ...
        self.assertGreaterEqual(diag_blocks.count(), 10, "Expected at least 10 diagram blocks in Topic 2")
    ...
    def test_07_content_purification(self):
        """Scan all blocks across Topic 2 for zero prompt leaks, zero bracket citations, and clean formatting."""
        forbidden_patterns = [
            r'\[VISUAL:\s*.*?\]',
            r'\[\d+\]',
            r'\[image_\d+\]',
    ...
    def test_08_formative_mcqs_validation(self):
        ...
        self.assertGreaterEqual(mcq_blocks.count(), 15, "Expected at least 15 MCQs across Topic 2")
