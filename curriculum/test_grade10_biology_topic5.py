...
Validates:
  1. Curriculum Hierarchy (CBC -> Grade 10 -> Biology -> Topic 5)
  ...
  7. Content Leak Audit (Zero [VISUAL: ...] tags, zero citation brackets [139], zero corrupted LaTeX)

Usage:
  ./venv/bin/python curriculum/test_grade10_biology_topic5.py
"""
...
def run_tests():
    print("=" * 80)
    print("RUNNING AUTOMATED QA: GRADE 10 BIOLOGY TOPIC 5 (PLANT NUTRITION & PHOTOSYNTHESIS)")
    print("=" * 80)
    ...
    if not topic:
        errors.append("Topic 'Plant Nutrition and Photosynthesis' not found under Grade 10 Biology!")
    ...
    leak_patterns = [
        ...
        (r'\[(?:\d+|image_\d+)\]', "Raw Bracket Citation Leak [e.g. 139]"),
    ...
    print("\n[SUCCESS] ALL GRADE 10 BIOLOGY TOPIC 5 TESTS PASSED!")
    return True
