"""
VLearn Automated QA Suite: Grade 10 Aviation — Topic 366 (ID: 366)
...
class TestGrade10AviationTopic366(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls.subject = Subject.objects.get(id=44)
        cls.topic = Topic.objects.get(id=366, subject=cls.subject)
        cls.lessons = Lesson.objects.filter(topic=cls.topic).order_by("learning_unit__order")
        cls.expected_lessons = [
            (0, "Airfoil & Lift Generation"),
            (1, "The Four Forces of Flight"),
            (2, "Three Axes of Rotation & Flight Controls"),
            (3, "Aerodynamic Hazards: Stalls"),
            (4, "Wingtip Vortices & Wake Turbulence")
        ]

    def test_topic_hierarchy(self):
        """Verify Topic 366 exists with correct attributes and lessons."""
        self.assertEqual(self.topic.name, "Aerodynamics of Flight")
        ...
        self.assertEqual(self.lessons.count(), 5, f"Expected 5 Lessons under Topic 366, found {self.lessons.count()}")
    ...
    def test_card_atomicity_and_blocks(self):
        ...
        expected_images = [
            "https://upload.wikimedia.org/wikipedia/commons/a/a2/Airfoil_lift_and_drag.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/8/84/Cessna_172_RG_in_flight_by_Don_Ramey_Logan.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/0/02/Aircraft_controls_%2816436200715%29.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/a/a8/FA-18C_vapor_LEX_and_wingtip_1.jpg",
            "https://upload.wikimedia.org/wikipedia/commons/f/fe/Airplane_vortex_edit.jpg"
        ]
        expected_videos = [
            "https://www.youtube.com/watch?v=dpNCU37z4vU",
            "https://www.youtube.com/watch?v=imDKWTt5cfk",
            "https://www.youtube.com/watch?v=53rzgOpFnIs",
            "https://www.youtube.com/watch?v=xxLNVRxNJZA",
            "https://www.youtube.com/watch?v=-34-Igi5UMc"
        ]
    ...
    def test_lesson_assets_count(self):
        """Verify 15 LessonAssets exist and are bound to Topic 366 lessons."""
