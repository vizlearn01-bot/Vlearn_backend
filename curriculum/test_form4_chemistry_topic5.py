"""
Test suite for Form 4 Chemistry Topic 5: Metals
"""
...
def test_form4_chemistry_topic5():
    ...
    # Verify videos in Lesson 106 and 107
    l106 = Lesson.objects.get(id=106)
    l107 = Lesson.objects.get(id=107)
    assert LessonAsset.objects.filter(lesson=l106, asset_type='youtube').exists(), "Lesson 106 missing video"
    assert LessonAsset.objects.filter(lesson=l107, asset_type='youtube').exists(), "Lesson 107 missing video"

    print("✅ All 13 Form 4 Chemistry Topic 5 lessons passed validation tests!")

if __name__ == "__main__":
    test_form4_chemistry_topic5()
