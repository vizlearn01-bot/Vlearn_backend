"""
Automated Quality Assurance Test Suite for CBC Grade 8 Agriculture — Topic 1: Soil Conservation Measures
(Deep Pedagogical & Multi-Video Edition)

Curriculum: CBC -> Grade 8 -> Agriculture -> Topic 1: Soil Conservation Measures

Test Coverage:
  1. Hierarchy and Topic Configuration Integrity (Grade 8, Topic Order: 1)
  ...
  6. Multi-Video Integration (Videos across Lessons 1, 3, 4, 6, and 8 with attached LessonAssets)
...
Run:
  ./venv/bin/python curriculum/test_cbc_grade8_agriculture_topic1.py
"""
...
class TestCBCGrade8AgricultureTopic1(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.topic_name = "Soil Conservation Measures"
    ...
    def test_01_hierarchy_integrity(self):
        ...
        self.assertEqual(self.topic.order, 1, "Topic 1 order must be 1")
