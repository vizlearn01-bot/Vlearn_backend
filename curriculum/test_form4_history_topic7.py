"""
VLearn Form 4 History — Automated Test Suite for Topic 7: Devolved Government

Verifies:
  1. Target Subject, Grade, Curriculum mapping (History, Form 4, 844)
  2. Topic 7 existence and ordering (Order: 7)
...
Usage:
  ./venv/bin/python curriculum/test_form4_history_topic7.py
"""
...
def test_form4_history_topic7():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 HISTORY TOPIC 7 (DEVOLVED GOVERNMENT)")
    print("=" * 80)
    ...
    # 2. Check Topic
    topic = Topic.objects.filter(subject=subject, name="Devolved Government").first()
    assert topic, "Topic 7 not found!"
    assert topic.order == 7, f"Topic order is {topic.order}, expected 7"
    ...
    print("[PASS] 4.1 Every single lesson in Topic 7 has an establishing real-world visual on Page 1.")
    ...
    expected_pages = {
        1: 15, # Historical Development of Local Government: From Colonial Control to African District Councils
        2: 15, # Local Authorities under Cap 265: Structures, Functions, Leadership Duality, and Systemic Failures
        3: 15, # Transition to Devolution: Constitutional Objectives, Principles, and Structural Comparison
        4: 16, # County Governments: Structures, Devolved Functions, Revenue Sources, and Governance Challenges
        5: 18  # Intergovernmental Relations, Coordination Organs, Dispute Resolution, and Master Synthesis
    }
    ...
    # 9. Check for Bracket Citation Leakage ([180], [26], [1])
    ...
    print("=" * 80)
    print(f"[ALL TESTS PASSED] Form 4 History Topic 7 is fully verified, robust, and production-ready!")
