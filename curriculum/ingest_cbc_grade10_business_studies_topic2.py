...
from curriculum.cbc_grade10_business_studies_topic2_data import TOPIC_2_LESSONS
...
def ingest_grade10_business_studies_topic2(replace=True):
    print("=" * 80)
    print("INGESTING TOPIC 2: Business Goals (Grade 10 Business Studies)")
    print("=" * 80)
    ...
    topic, t_created = Topic.objects.get_or_create(
        ...
        defaults={
            "name": "Business Goals",
            "description": "Principles and processes of setting, aligning, monitoring, and evaluating short- and long-term business goals."
        }
    )
    if not t_created:
        topic.name = "Business Goals"
        topic.description = "Principles and processes of setting, aligning, monitoring, and evaluating short- and long-term business goals."
        topic.save()
            ...
            for page_idx, page_blocks in enumerate(pages, start=1):
                ...
                for comp_idx, block_def in enumerate(page_blocks, start=1):
                    ...
                    block = LessonBlock.objects.create(
                        lesson=lesson,
                        block_id=f"g10_bs_t2_u{u_order}_p{page_idx}_b{comp_idx}",
                        block_type=b_type,
