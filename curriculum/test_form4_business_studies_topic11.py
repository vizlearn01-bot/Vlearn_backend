"""
VLearn Form 4 Business Studies — Automated Test Suite: Topic 11 (Ledger)
"""
...
def run_tests():
    print("=" * 80)
    print("RUNNING AUTOMATED TEST SUITE: FORM 4 BUSINESS STUDIES TOPIC 11 (LEDGER)")
    print("=" * 80)
    ...
    assert topic is not None, "Topic 11 (Ledger) not found!"
    assert topic.name == "Ledger", f"Unexpected topic name: {topic.name}"
    ...
    print("=" * 80)
    print("[ALL TESTS PASSED] Form 4 Business Studies Topic 11 is 100% verified and production-ready!")
    print("=" * 80)
